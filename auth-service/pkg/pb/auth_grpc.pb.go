...
func (c *authServiceClient) Verify(ctx context.Context, in *UserVerifyRequest, opts ...grpc.CallOption) (*UserVerifyResponse, error) {
...
func (UnimplementedAuthServiceServer) Verify(context.Context, *UserVerifyRequest) (*UserVerifyResponse, error) {
...
func _AuthService_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Verify(ctx, req.(*UserVerifyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
